...
COLUMN_ALIASES = {
    ...
    "ref":   ["referenz", "reference", "ref", "designator", "refdes", "bauteil"],
...
def detect_header_row(raw: list) -> int:
    """
    Scan first 15 rows to find the header.
    Returns the row index of the header, or 0 if not found.
    """
    keywords = {"pos", "pos.", "ref", "qty", "qty.", "menge", "anzahl",
                "referenz", "reference", "designator", "description", "text"}
